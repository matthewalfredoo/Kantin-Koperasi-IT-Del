...
import com.kel01.kantinkoperasiitdel.activity.LoginActivity
import com.kel01.kantinkoperasiitdel.activity.RegisterActivity
...
class AkunFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var btnLoginAkun: Button
    ...
    override fun onCreateView(
        ...
        btnLoginAkun = view.findViewById(R.id.btnLoginAkun)
        btnLoginRegister = view.findViewById(R.id.btnRegisterAkun)

        btnLoginAkun.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        if(v != null) {
            when(v.id) {
                ...
                R.id.btnRegisterAkun -> {
                    val intent = Intent(this.requireActivity(), RegisterActivity::class.java)
                    startActivity(intent)
                }
            }
        }
